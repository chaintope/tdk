...
//!
//! 1. Data source agnostic -- nothing in `tdk_chain` cares about where you get data from or whether
//!    you do it synchronously or asynchronously. If you know a fact about the blockchain, you can just
//!    tell `tdk_chain`'s APIs about it, and that information will be integrated, if it can be done
//!    consistently.
//! 2. Data persistence agnostic -- `tdk_chain` does not care where you cache on-chain data, what you
